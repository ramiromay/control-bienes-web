...
const AdministradorMuebleDesincorporacionDatoGeneralForm = ({
  formManager = null,
  complementos = {},
  ...
  const { bienes, unidadesAdministrativas } = complementos;
...
export default AdministradorMuebleDesincorporacionDatoGeneralForm;

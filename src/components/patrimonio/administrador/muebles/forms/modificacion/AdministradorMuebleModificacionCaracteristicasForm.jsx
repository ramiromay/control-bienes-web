...
const AdministradorMuebleModificacionCaracteristicasForm = ({
  formManager = null,
  complementos = {},
  ...
  const { CARACTERISTICAS, AUX_CARACTERISTICA } = CAMPOS_ALTA_MUEBLE;
...
export default AdministradorMuebleModificacionCaracteristicasForm;

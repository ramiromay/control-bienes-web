...
const AdministradorVehiculoMovimientoDatoGeneralForm = ({
  formManager = null,
  complementos = {},
  ...
  const changeUnidadAdministrativa = (unidadAdministrativa) => {
    ...
    // cambio centro costo
    if (informacionExtra.idMotivoTramite === 50) {
    ...
    } else if (informacionExtra.idMotivoTramite === 52) {
  ...
  return (
    <>
      ...
      <FormCampoAutocompletarMultiple
        ...
        required
      />
      {(informacionExtra.idMotivoTramite === 50 ||
        informacionExtra.idMotivoTramite === 51) && (
        <FormCampoAutocompletar
      ...
      <FormCampoAutocompletar
        ...
        required
      />
      {informacionExtra.idMotivoTramite === 52 && (
        <FormCampoAutocompletarMultiple
...
export default AdministradorVehiculoMovimientoDatoGeneralForm;

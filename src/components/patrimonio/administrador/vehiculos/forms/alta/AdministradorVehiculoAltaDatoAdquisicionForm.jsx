...
import { CAMPOS_ALTA_VEHICULO } from "../../../../../../settings/formConfig";

const AdministradorVehiculoAltaDatoAdquisicionForm = ({
  formManager = null,
...
export default AdministradorVehiculoAltaDatoAdquisicionForm;

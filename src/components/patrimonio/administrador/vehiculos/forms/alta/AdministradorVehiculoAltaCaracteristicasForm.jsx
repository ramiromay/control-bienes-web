...
const AdministradorVehiculoAltaCaracteristicasForm = ({
  formManager = null,
  complementos = {},
  ...
  const { CARACTERISTICAS, AUX_CARACTERISTICA } = CAMPOS_ALTA_VEHICULO;
...
export default AdministradorVehiculoAltaCaracteristicasForm;

...
const AdministradorVehiculoSolicitudForm = () => {
  const {
    ID_SOLICITUD_MUEBLE,
    SOLICITANTE,
    OBSERVACIONES,
  ...
  const tituloDialogo = getTituloDialogo("Solicitud Bien Vehículo");
      ...
      .then(
        ([
          ...
          const tiposTramites = mapArray(
            tiposTramitesData.filter((e) => e.idSubModulo === 3),
            compTipoTramiteMappingRules
          );
...
export default AdministradorVehiculoSolicitudForm;

...
const AdministradorVehiculoSeguimiento = () => {
  const { handleError } = useSistema();
  const { dialogoTramites } = useAdministradorVehiculo();
  ...
  const tituloDialogo = "Seguimiento Trámite Vehículo";
...
export default AdministradorVehiculoSeguimiento;

...
const AdministradorInmuebleSeguimiento = () => {
  const { handleError } = useSistema();
  const { dialogoTramites } = useAdministradorInmueble();
  ...
  const tituloDialogo = "Seguimiento Trámite Inmueble";
...
export default AdministradorInmuebleSeguimiento;

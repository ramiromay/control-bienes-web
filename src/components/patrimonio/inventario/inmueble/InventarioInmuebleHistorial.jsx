...
import {
  getHistorialBienInmueble,
  getHistorialBienMueble,
...
const InventarioInmuebleHistorial = () => {
  ...
  const tituloDialogo = "Historial Bien Inmueble";

  useEffect(() => {
    setCargando(true);
    const idBien = filaSeleccionadaData.idBien;
    getHistorialBienInmueble({ idBien: idBien })
      .then((historial) => {
...
export default InventarioInmuebleHistorial;

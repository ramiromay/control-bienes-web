...
const InventarioVehiculoDepreciacion = () => {
  const { handleError } = useSistema();
  const { dialogoManager, formManager } = useInventarioVehiculo();
  ...
  const tituloDialogo = "Depreciación del Bien Vehículo";
  ...
  return (
    ...
    >
      ...
      {!cargando && !tieneRegistros && (
        <Mensaje mensaje="No se han encontrado registros de depreciación para este bien vehículo" />
      )}
    </DialogoEmergente>
  );
};

export default InventarioVehiculoDepreciacion;
